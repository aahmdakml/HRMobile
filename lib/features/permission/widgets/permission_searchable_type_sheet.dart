...
class PermissionSearchableTypeSheet extends StatefulWidget {
  final List<TimeOffType> options;
  final String? selectedCode;

  const PermissionSearchableTypeSheet({
    super.key,
  ...
  @override
  State<PermissionSearchableTypeSheet> createState() =>
      _PermissionSearchableTypeSheetState();
}

class _PermissionSearchableTypeSheetState
    extends State<PermissionSearchableTypeSheet> {
  final TextEditingController _searchController = TextEditingController();
  List<TimeOffType> _filteredOptions = [];
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search permission types...',
                  hintStyle: TextStyle(
